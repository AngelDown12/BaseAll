...
global.packname = `𝗔𝗹𝗲𝗲 - 𝗕𝗼𝘁 👑`
global.author = '{\n "𝗕𝗼𝘁": {\n   "name": "𝗔𝗹𝗲𝗲 - 𝗕𝗼𝘁",\n     "author": "𝗔𝗹𝗲𝗲",\n   "status_bot": "active"\n }\n}'
global.wait = '𝗔𝗹𝗲𝗲 - 𝗕𝗼𝘁'
global.botname = '𝗔𝗹𝗲𝗲 - 𝗕𝗼𝘁'
global.textbot = `𝗪𝗵𝗮𝘁𝘀𝗮𝗽𝗽 𝗔𝗹𝗲𝗲 𝗕𝗼𝘁 👑`
global.listo = '𝗙𝗶𝗻𝗮𝗹𝗶𝘇𝗮𝗱𝗼 👑'
global.namechannel = '𝗔𝗹𝗲𝗲 𝗕𝗼𝘁 👑'
global.baileys = '@whiskeysockets/baileys'

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.catalogo = 'https://qu.ax/xfFfw.jpg'
global.miniurl = 'https://qu.ax/xfFfw.jpg'
